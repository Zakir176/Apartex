<template>
  ...
  >
    ...
    >
      <!-- Left: Logo -->
      <router-link to="/" class="flex-shrink-0 flex items-center gap-2.5 text-xl font-black text-navy tracking-tight pl-1 hover:opacity-85 transition-all group no-underline">
